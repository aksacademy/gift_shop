...
<html lang="zxx">
    ...
    <body>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu multi-column columns-3">
                                            <div class="agile_inner_drop_nav_info">
                                                ...
                                                <div class="col-sm-4 multi-gd-img">
                                                    <img src="<?php echo base_url() ?>assets/user/images/nav.png" alt="">
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </ul>
                    ...
                    <div class="deal-leftmk left-side">
                        ...
                        <div class="special-sec1">
                            <div class="col-xs-4 img-deals">
                                <img src="<?php echo base_url() ?>assets/user/images/d2.jpg" alt="">
                            </div>
                        ...
                        <div class="special-sec1">
                            <div class="col-xs-4 img-deals">
                                <img src="<?php echo base_url() ?>assets/user/images/d1.jpg" alt="">
                            </div>
                            <div class="col-xs-8 img-deal1">
                        ...
                        <div class="special-sec1">
                            <div class="col-xs-4 img-deals">
                                <img src="<?php echo base_url() ?>assets/user/images/d4.jpg" alt="">
                            </div>
                            <div class="col-xs-8 img-deal1">
                                <h3>Tata Salt</h3>
                        ...
                        <div class="special-sec1">
                            <div class="col-xs-4 img-deals">
                                <img src="<?php echo base_url() ?>assets/user/images/d5.jpg" alt="">
                            </div>
                            <div class="col-xs-8 img-deal1">
                        ...
                        <div class="special-sec1">
                            <div class="col-xs-4 img-deals">
                                <img src="<?php echo base_url() ?>assets/user/images/d3.jpg" alt="">
                            </div>
                            <div class="col-xs-8 img-deal1">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="product-sec1">
                            ...
                            <div class="col-md-4 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="<?php echo base_url() ?>assets/user/images/m1.jpg" alt="">
                            ...
                            <div class="col-md-4 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="<?php echo base_url() ?>assets/user/images/m2.jpg" alt="">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                            ...
                            <div class="col-md-4 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="<?php echo base_url() ?>assets/user/images/m3.jpg" alt="">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                        ...
                        <div class="product-sec1 product-sec2">
                            ...
                            <div class="col-xs-5 bg-right-nut">
                                <img src="<?php echo base_url() ?>assets/user/images/nut1.png" alt="">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <!-- //second section (nuts special) -->
                        ...
                        <div class="product-sec1">
                            ...
                            <div class="col-md-4 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="<?php echo base_url() ?>assets/user/images/mk4.jpg" alt="">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                            ...
                            <div class="col-md-4 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="<?php echo base_url() ?>assets/user/images/mk5.jpg" alt="">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                            ...
                            <div class="col-md-4 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="<?php echo base_url() ?>assets/user/images/mk6.jpg" alt="">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                        ...
                        <div class="product-sec1">
                            ...
                            <div class="col-md-4 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="<?php echo base_url() ?>assets/user/images/mk7.jpg" alt="">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                            ...
                            <div class="col-md-4 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="<?php echo base_url() ?>assets/user/images/mk8.jpg" alt="">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                            ...
                            <div class="col-md-4 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="<?php echo base_url() ?>assets/user/images/mk9.jpg" alt="">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
                    ...
                    <ul id="flexiselDemo1">
                        <li>
                            <div class="w3l-specilamk">
                                <div class="speioffer-agile">
                                    <a href="single.html">
                                        <img src="<?php echo base_url() ?>assets/user/images/s1.jpg" alt="">
                                    </a>
                                </div>
                        ...
                        <li>
                            <div class="w3l-specilamk">
                                <div class="speioffer-agile">
                                    <a href="single.html">
                                        <img src="<?php echo base_url() ?>assets/user/images/s4.jpg" alt="">
                                    </a>
                                </div>
                                <div class="product-name-w3l">
                                    <h4>
                        ...
                        <li>
                            <div class="w3l-specilamk">
                                <div class="speioffer-agile">
                                    <a href="single.html">
                                        <img src="<?php echo base_url() ?>assets/user/images/s2.jpg" alt="">
                                    </a>
                                </div>
                                <div class="product-name-w3l">
                                    <h4>
                        ...
                        <li>
                            <div class="w3l-specilamk">
                                <div class="speioffer-agile">
                                    <a href="single2.html">
                                        <img src="<?php echo base_url() ?>assets/user/images/s3.jpg" alt="">
                                    </a>
                                </div>
                                <div class="product-name-w3l">
                                    <h4>
                        ...
                        <li>
                            <div class="w3l-specilamk">
                                <div class="speioffer-agile">
                                    <a href="single.html">
                                        <img src="<?php echo base_url() ?>assets/user/images/s8.jpg" alt="">
                                    </a>
                                </div>
                                <div class="product-name-w3l">
                                    <h4>
                        ...
                        <li>
                            <div class="w3l-specilamk">
                                <div class="speioffer-agile">
                                    <a href="single2.html">
                                        <img src="<?php echo base_url() ?>assets/user/images/s6.jpg" alt="">
                                    </a>
                                </div>
                                <div class="product-name-w3l">
                                    <h4>
                        ...
                        <li>
                            <div class="w3l-specilamk">
                                <div class="speioffer-agile">
                                    <a href="single.html">
                                        <img src="<?php echo base_url() ?>assets/user/images/s5.jpg" alt="">
                                    </a>
                                </div>
                                <div class="product-name-w3l">
                                    <h4>
                        ...
                        <li>
                            <div class="w3l-specilamk">
                                <div class="speioffer-agile">
                                    <a href="single2.html">
                                        <img src="<?php echo base_url() ?>assets/user/images/s9.jpg" alt="">
                                    </a>
                                </div>
                                <div class="product-name-w3l">
                                    <h4>
        ...
        <div class="footer-top">
            <div class="container-fluid">
                ...
                <div class="col-xs-4 w3l-rightmk">
                    <img src="<?php echo base_url() ?>assets/user/images/tab3.png" alt=" ">
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="footer-info w3-agileits-info">
                    ...
                    <div class="col-sm-2 footer-grids  w3l-socialmk">
                        ...
                        <div class="agileits_app-devices">
                            ...
                            <a href="#">
                                <img src="<?php echo base_url() ?>assets/user/images/1.png" alt="">
                            </a>
                            <a href="#">
                                <img src="<?php echo base_url() ?>assets/user/images/2.png" alt="">
                            </a>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                ...
                <div class="agile-sometext">
                    ...
                    <div class="sub-some child-momu">
                        ...
                        <ul>
                            <li>
                                <img src="<?php echo base_url() ?>assets/user/images/pay2.png" alt="">
                            </li>
                            <li>
                                <img src="<?php echo base_url() ?>assets/user/images/pay5.png" alt="">
                            </li>
                            <li>
                                <img src="<?php echo base_url() ?>assets/user/images/pay1.png" alt="">
                            </li>
                            <li>
                                <img src="<?php echo base_url() ?>assets/user/images/pay4.png" alt="">
                            </li>
                            <li>
                                <img src="<?php echo base_url() ?>assets/user/images/pay6.png" alt="">
                            </li>
                            <li>
                                <img src="<?php echo base_url() ?>assets/user/images/pay3.png" alt="">
                            </li>
                            <li>
                                <img src="<?php echo base_url() ?>assets/user/images/pay7.png" alt="">
                            </li>
                            <li>
                                <img src="<?php echo base_url() ?>assets/user/images/pay8.png" alt="">
                            </li>
                            <li>
                                <img src="<?php echo base_url() ?>assets/user/images/pay9.png" alt="">
                            </li>
                        </ul>
                    </div>
                    <!-- //payment -->
        ...
        <!-- smoothscroll -->
        <script src="<?php echo base_url() ?>assets/user/js/SmoothScroll.min.js"></script>
        <!-- //smoothscroll -->
