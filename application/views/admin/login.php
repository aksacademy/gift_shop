        ...
        <section class="body-sign">
            <div class="center-sign">
                <!--<a href="/" class="logo pull-left">
                    <img src="<?php //echo base_url() ?>assets/admin/images/logo.png" height="54" alt="Porto Admin" />
                </a>-->
                        ...
                        <form action="<?php echo base_url() ?>/admin/login/validate" method="post">
                            <div class="form-group mb-lg">
                                ...
                                <div class="input-group input-group-icon">
                                    <input name="username" placeholder="Enter username" required="" type="text" class="form-control input-lg" />
                            ...
                            <div class="form-group mb-lg">
                                ...
                                <div class="input-group input-group-icon">
                                    <input name="password" placeholder="Enter password" required="" type="password" class="form-control input-lg" />
                                    <span class="input-group-addon">
                                        <span class="icon icon-lg">
                ...
                <p class="text-center text-muted mt-md mb-md"> Design & Develop By <a href="#">Rinkal, Pinkal & Piyush</a>.</p>
            </div>
        </section>
        <!-- end: page -->
