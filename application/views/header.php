...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/user/css/jquery.countdown.css" />
        <!-- Custom Theme files -->
        <!--webfont-->
        <link href='http://fonts.googleapis.com/css?family=Raleway:100,200,300,400,500,600,700,800,900' rel='stylesheet' type='text/css'>
        <script type="text/javascript" src="<?php echo base_url() ?>assets/user/js/jquery-1.11.1.min.js"></script>
        <!-- dropdown -->
        <script src="<?php echo base_url() ?>assets/user/js/jquery.easydropdown.js"></script>
        <!-- start menu -->
        <link href="<?php echo base_url() ?>assets/user/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
        <script type="text/javascript" src="<?php echo base_url() ?>assets/user/js/megamenu.js"></script>
        ...
        <script src="<?php echo base_url() ?>assets/user/js/jquery.countdown.js"></script>
            ...
            <div class="container">
                <div class="header_bottom-box">
                    <div class="header_bottom_left">
                        <div class="logo">
                            <a href="index.html"><img src="<?php //echo base_url()  ?>assets/user/images/logo2.png" alt=""/></a>
                        </div>
                                    ...
                                    <div class="col2">
                                        <div class="h_nav">
                                            ...
                                            <ul>
                                                <li class>
                                                    <div class="p_left">
                                                        <img src="<?php echo base_url() ?>assets/user/images/t1.jpg" class="img-responsive" alt=""/>
                                                    </div>
                                                    <div class="p_right">
                                                ...
                                                <li>
                                                    <div class="p_left">
                                                        <img src="<?php echo base_url() ?>assets/user/images/t2.jpg" class="img-responsive" alt=""/>
                                                    </div>
                                                    <div class="p_right">
                                                        <h4><a href="#">Denim shirt</a></h4>
                                                        <span class="item-cat"><small><a href="#">Jackets</a></small></span>
                                                ...
                                                <li>
                                                    <div class="p_left">
                                                        <img src="<?php echo base_url() ?>assets/user/images/t3.jpg" class="img-responsive" alt=""/>
                                                    </div>
                                                    <div class="p_right">
                                                        <h4><a href="#">Denim shirt</a></h4>
                                                        <span class="item-cat"><small><a href="#">Jackets</a></small></span>
